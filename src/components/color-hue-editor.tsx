...
export default function ColorHueEditor({hue, onHueChanged}: ColorHueEditorParams) {
    ...
    return <div className="flex flex-col w-64">
        <div className="flex flex-row w-full">
            <label htmlFor="hue-editor" className="text-slate-950 dark:text-slate-50 flex-1">Hue</label>
            <input id="hue-editor" name="hue-editor" type="number" min="0" max="360" step="0.001" defaultValue={hue.toFixed(3)} onChange={change}/>
        </div>
